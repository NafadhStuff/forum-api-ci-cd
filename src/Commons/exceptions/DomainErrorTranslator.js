...
DomainErrorTranslator._directories = {
  ...
  'ADDED_THREAD.NOT_CONTAIN_MATCH_TYPE_FIELD': new InvariantError('title dan body harus string'),
  'NEW_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('harus mengirimkan title dan body'),
  'NEW_THREAD.NOT_CONTAIN_MATCH_TYPE_FIELD': new InvariantError('title dan body harus string'),
  'NEW_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('harus mengirimkan content'),
  'NEW_COMMENT.NOT_CONTAIN_MATCH_TYPE_FIELD': new InvariantError('content harus string'),
};
